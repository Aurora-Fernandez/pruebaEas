 ...
 * Si ocurre algun cambio en el dominio se les notifica a las agencias con un
 * mensaje AGENCYS.
 */
    ...
    class ReceiveMessageThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                if (!message.recipient.host.equals(raAddress.host)) {
                ...
                } else if (message.kind.equals("AGENCY_ONLINE")) {
                    System.out.println("ReceiveMessageThread: Ha llegado un mensaje AGENCY_ONLINE: "
                            + message.sender.host.toString());
                    ...
                    System.out.println("ReceiveMessageThread: Ha llegado un Mensaje AGENCY_OFFLINE: "
                            + message.sender.host.toString());
    ...
    class SendMessageThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("SendMessageThread: socket creado a: " + msg.recipient.host.toString() + " "
                        + msg.recipient.port);
                outStream = new ObjectOutputStream(
                        socket.getOutputStream());
                inStream = new ObjectInputStream(
