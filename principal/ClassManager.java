...
public class ClassManager {
    ...
    /**
     * Clase auxiliar del ClassManager que borra una clase despues del tiempo de
     * retardo.
     */
    class Remover extends Thread {
        ...
        /**
         * Tiempo de retardo en milisegundos despues del cual la clase es borrada si su
        ...
        /**
         * Espera el tiempo de retardo especificado y entonces borra la clase de la
         * cache si el contador llega cero;
         */
        public void run() {
            try {
                Thread.sleep(delay);
     ...
     *
     * @param delay Tiempo en milisegundos que el ClassManager espera antes de que
     *              una
