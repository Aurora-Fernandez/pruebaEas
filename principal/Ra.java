...
/**
 * La clase Ra implementa la clase base de un agente m�vil.
...
public class Ra implements Runnable, Serializable {
     ...
     * puede ser la destrucci�n de un agente. Tambien algunas reacciones a esos
    ...
    class FireEventThread extends Thread implements Serializable {
        ...
        /**
         * Chequea los id de las llamadas al m�todo apropiado del
         * listener de eventos.
         */
        public void run() {
            switch (event.id) {
     ...
     * Los mensajes se deben lanzar de modo asincrono debido a que un resultado del
     * lanzamiento
     * de mensajes podria ser continuar la comunicaci�n entre
     * objetos.
     */
    class FireMessageThread extends Thread implements Serializable {
        ...
        /**
         * Llama al m�todo RaMessage(m) del RaMesssageListener.
         */
        public void run() {
     ...
     * Es leido por la agencia a trav�s del m�todo getDestination().
     */
    ...
    /**
     * El listener de emnsajes que recibe todos los RaMessages. Es normalmente
     * puesto por la agencia
     * en llegada.
     */
     ...
     *             metodo que genera un nombre �nico.
     */
